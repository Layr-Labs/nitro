...
func getDAS(
	...
	l1client *ethclient.Client,
	stack *node.Node,
) (daprovider.Writer, func(), *daprovider.ReaderRegistry, eigenda.EigenDAWriter, error) {
...
func createNodeImpl(
	...
	batchPoster, err := getBatchPoster(ctx, config, configFetcher, txOptsBatchPoster, dapWriter, l1Reader, inboxTracker, txStreamer, arbOSVersionGetter, arbDb, syncMonitor, deployInfo, parentChainID, dapReaders, stakerAddr, eigenDAWriter)
	if err != nil {
		return nil, err
	}
